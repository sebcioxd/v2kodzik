...
export async function sendEmail(to: string, subject: string, text: string, emailType: EmailType) {
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; width: 100%; background-color: #09090b; border: 1px solid #27272a; border-radius: 8px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 30px; background-color: #09090b;">
              ...
              <p style="margin-bottom: 30px; font-size: 16px; line-height: 1.5; color: #a1a1aa;">Aby aktywować swoje konto i rozpocząć korzystanie z naszych usług, potwierdź swój adres email.</p>
              
              <!-- Button -->
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="center" style="padding: 20px 0;">
                    <a href="${text}" target="_blank" style="display: inline-block; padding: 12px 24px; font-size: 16px; color: #f8fafc; text-decoration: none; border-radius: 4px; background-color: #18181b; border: 1px solid #27272a;">Potwierdź adres e-mail</a>
                  </td>
                </tr>
              </table>
              
              <p style="margin-bottom: 20px; font-size: 14px; line-height: 1.5; color: #71717a;">Link weryfikacyjny wygaśnie za 24 godziny.</p>
              
              <p style="margin-bottom: 0; font-size: 14px; line-height: 1.5; color: #71717a;">Link do weryfikacji:</p>
