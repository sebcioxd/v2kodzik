...
export async function getShareFileService({ slug, c }) {
...
export async function verifyShareCodeService({ code, slug, c }) {
    if (!code || !slug) {
        return c.json({
...
export async function verifyCookieService({ slug, c }) {
